...
The first thing you will need is a valid API key. Please visit [this link](https://cloud.cerebras.ai) and navigate to “API Keys” on the left nav bar.
...
* Learn how to [stream responses](streaming)